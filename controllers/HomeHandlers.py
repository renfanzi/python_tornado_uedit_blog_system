...
from common.tools.session import SessionFactory
...
class SessionBaseHandler(tornado.web.RequestHandler):
    ...
    def get_argument(self, name, default='', **kwargs):
        value = super(SessionBaseHandler, self).get_argument(name, default)
        return value
    ...
    def initialize(self):
        ...
        self.UserID = self.get_argument("UserID", UserID)
        self.TokenID = self.get_argument("TokenID", None)
        self.session = SessionFactory.get_session_obj(self)
